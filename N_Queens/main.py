...
def resize_img(img, new_width) :
    ...
    img = img.resize((int(new_width), hsize), Image.LANCZOS)
...
label_no_queens = Label(master=right_frame, text='Mumber of Queens:')
...
button_solve = Button(master=right_frame, text='Solve', command=lambda:set_no_queens(entry_no_queens.get()))
button_solve.pack()
